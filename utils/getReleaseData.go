...
func ReleaseData(StartDate string, EndDate string, ids string, pod1 string, environment string) (map[string]config.Value, map[string]config.Value) {
  ...
  "iics-qa-perfusw1":[
     {
      "scheduler-service":["POST /scheduler-service/api/v1/Schedules","PATCH /scheduler-service/api/v1/Schedules","GET scheduler-service/api/v1/Jobs","GET scheduler-service/api/v1/Organizations *and* /Jobs","POST /scheduler-service/api/v1/Schedules *and* /Jobs","PUT /scheduler-service/api/v1/Schedules","GET /scheduler-service/api/v1/Schedules","DELETE /scheduler-service/api/v1/Jobs","GET /scheduler-service/api/v1/Jobs","DELETE /scheduler-service/api/v1/Schedules","GET /scheduler-service/api/v1/Organizations *and* /Schedules"],
    ...
    {
        "frs":["GET /frs/internal/api/v1/DocumentTypes","GET /frs/api/v1/DocumentTypes","GET /frs/api/v1/Projects","POST /frs/api/v1/Projects","POST /frs/v1/Projects *and* /Folders","GET /frs/api/v1/Projects","GET /frs/v1/Folders(","POST /frs/api/v1/UpdateEntityAccess","POST /frs/v1/GetPermissions","POST frs/v1/GetEffPrivilegeForDoctypeContainer","GET /frs/api/v1/Projects?$expand=sourceControlAttributes&$orderby=name","POST /frs/v1/LookupArtifactsDetailsByPath","GET /frs/api/v1/FetchProjectStatForRecentEntity()","GET /frs/api/v1/FetchDefaultLocation()","GET /frs/api/v1/BaseEntities","DELETE /frs/v1/Folders(","DELETE /frs/api/v1/Projects("],
        "containername":"frs",
